 ...
 */
export async function handleNonStreamingResponse({ providerResponse, provider, model, sourceFormat, targetFormat, body, stream, translatedBody, finalBody, requestStartTime, connectionId, apiKey, apiKeyId, clientRawRequest, onRequestSuccess, reqLogger, toolNameMap, customToolNames, trackDone, appendLog, pxpipe, reqTag, log }) {
  trackDone();
  ...
  saveUsageStats({ provider, model, tokens: usage, connectionId, apiKey, apiKeyId, endpoint: clientRawRequest?.endpoint, silent: true });
